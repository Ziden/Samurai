...
public class PlayerBhv : MonoBehaviour
{
    ...
    private float gravityPull = 0.3f;
    private float yCollisionCorrection = 0.3f;
    private float xCollisionCorrection = 0.35f;
    private float fastFallRate = 2f;
    private float dashLength = 3.2f;
    private float dashPower = 2.5f;
    private float attackDelay = 0.00f;
    private float landYAdjust = 0.10f;
